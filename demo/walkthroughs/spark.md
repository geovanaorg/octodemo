...
2. Use the following prompt to link the prototype to the main app and have Copilot draft a specification issue:
    ...
    ```txt
      Generate a plan to integrate the prototype I've built in @msft-common-demos/od-octocat-supply-order-tracking-prototype into our main application at @msft-common-demos/octocat_supply-laughing-octo-funicular
